...
abstract class DWDData_Action extends Yaf\Action_Abstract
{
    ...
    public function renderJson($psResultData, $errNO =DWDData_ErrorCode::NORMAL, $errMsg = DWDData_ErrorCode::NORMAL_MSG)
    {
        ...
        if (defined("PHP_FPM_ENV")) {
            ...
            DWDData_Logger::getInstance()->addNotice('server', HttpServer::$server);
            DWDData_Logger::getInstance()->addNotice('get', HttpServer::$get);
            DWDData_Logger::getInstance()->addNotice('post', HttpServer::$post);
            DWDData_Logger::getInstance()->addNotice('cost', (DWDData_Util::getmicrotime() - HttpServer::$start) * 1000);
            DWDData_Logger::getInstance()->addNotice('errno', $errNO);
            DWDData_Logger::getInstance()->notice();
        }
